...
const userController = {
    ...
    async getEdit(req, res) {
        try {
            ...
            res.render('users/user_edit', { editUser, error: null });
        } catch (error) {
            console.error(error);
    ...
    async postEdit(req, res) {
        ...
        try {
            ...
            console.error(error);
            const editUser = await User.findById(id);
            res.render('users/user_edit', { editUser, error: 'Lỗi khi cập nhật người dùng' });
        }
    },
    ...
    async getRebin(req, res) {
        try {
            ...
            res.render('users/user_rebin', { users });
        } catch (error) {
            console.error(error);
            res.redirect('/users/dashboard');
        }
    ...
    async postRestore(req, res) {
        try {
            ...
            res.redirect('/users/dashboard/rebin');
        } catch (error) {
            console.error(error);
            res.redirect('/users/dashboard/rebin');
        }
